      ...
      <div className="mx-auto flex h-[72px] w-full max-w-[1480px] min-w-0 items-center gap-3 px-3 md:px-5">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link
            ...
            aria-label={ui.myWishlist}
          >
            <Heart size={18} />
            {wishlistCount > 0 ? (
              <span className="absolute -right-1 -top-1 inline-flex h-5 min-w-[20px] items-center justify-center rounded-full bg-slate-900 px-1 text-xs font-bold text-white">
                {wishlistCount}
              </span>
            ) : null}
          </Link>
