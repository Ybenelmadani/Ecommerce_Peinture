...
BASE_URL = "https://www.montmarte.com"
PRODUCTS_ENDPOINT = f"{BASE_URL}/products.json"
DEFAULT_OUTPUT = "mont marte.json"
TIMEOUT_SECONDS = 30
...
def main():
    parser = argparse.ArgumentParser(
        description="Scrape all Mont Marte product data from montmarte.com and save to JSON."
    )
